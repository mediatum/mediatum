...
+ '<node name="content" id="None" type="document/testschema" datatype="document" schema="testschema"><attribute name="sortattr"><![CDATA[6]]></attribute></node></nodelist>'
...
def test_add_node_to_xmldoc_simple(nodelist, content_node):
