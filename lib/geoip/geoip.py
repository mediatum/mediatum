...
class GeoIP:
    def __init__(self, filename="", flags=0):
        ...
        if filename=="":
            # database http://www.maxmind.com
            filename = os.path.dirname(inspect.getfile(self.__class__))+"/GeoIP.dat" 
...
if __name__=="__main__":
    gi = GeoIP()
    print gi.country_name_by_addr("209.85.135.147") # ip of google
    print gi.country_code_by_name("209.85.135.147")
    
    print gi.country_name_by_addr("129.187.87.218") # ip of mediatum2
    print gi.country_code_by_name("129.187.87.218")
