...
class m_memo(Metatype):
    def getEditorHTML(self, field, value="", width=400, name="", lock=0, language=None):
        return athana.getTAL("m_memo.html", {"lock":lock, "value":value, "width":width, "name":name, "field":field}, macro="editorfield", language=language)

    def getSearchHTML(self, field, value="", width=174, name="", language=None):
        return athana.getTAL("m_memo.html",{"field":field, "value":value, "name":name}, macro="searchfield", language=language)
    ...
    def getMaskEditorHTML(self, value="", metadatatype=None, language=None):
        return athana.getTAL("m_memo.html", {"value":value}, macro="maskeditor", language=language)
