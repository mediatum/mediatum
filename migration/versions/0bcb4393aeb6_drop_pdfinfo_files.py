...
def upgrade():
    ...
    node_to_files_select = (_core.db.query(NodeToFile)
            .with_entities(NodeToFile.nid, NodeToFile.file_id)
            .join(File, NodeToFile.file_id == File.id)
    ...
    node_to_files = (_core.db.query(NodeToFile)
            .join(File, NodeToFile.file_id == File.id)
            .filter_by(filetype='fileinfo')
            .all()
        )
