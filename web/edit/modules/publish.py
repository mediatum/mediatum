    ...
    if "dopublish" in req.params.keys():
        ...
        if num_req_err_nodes > 0:
            if num_req_err_nodes < 2:
                publisherror.append(_core_translation.translate(language, "error_publish_single_node"))
            else:
                publisherror.append(_core_translation.translate(language, "error_publish_multiple_nodes"))
        if num_rights_err_nodes > 0:
            if num_rights_err_nodes < 2:
                publisherror.append(_core_translation.translate(language, "error_publish_rights_single"))
            else:
                publisherror.append(_core_translation.translate(language, "error_publish_rights_multiple"))
