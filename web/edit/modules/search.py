...
def search_form(req, id, message=None):
    ...
    try:
        ...
        indexdate = None
    ret += req.getTAL("web/edit/modules/search.html",{"node":node, "occur":occur, "mtypelist":mtypelist, "objtype":objtype, "searchvalues":searchvalues.get(str(otype)+".full", ""), "script":script, "indexdate":indexdate, "formlist":formlist},macro="search_form")
    return ret
