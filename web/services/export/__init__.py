...
def request_handler(req):
    ...
    s = "services %s '%s' (%s): %s for %s bytes for service request (%s, %s, %s) - (user-agent: %s)" % (req.ip, str(response_code), response_code_description, handle_duration, locale.format("%d", bytes_sent, 1), req.command, req.fullpath, req.params, useragent)
