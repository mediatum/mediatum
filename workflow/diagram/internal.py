...
class WorkflowImage:
    ...
    def drawStep(self, step):
        ...
        self.draw.rectangle(
            ((y * self.XSTEP), (x * self.YSTEP), (y * self.XSTEP) + self.XSIZE, (x * self.YSTEP) + self.YSIZE), self.framecolor)
        self.draw.rectangle(
            ((y * self.XSTEP) + 2, (x * self.YSTEP) + 2, (y * self.XSTEP) + self.XSIZE - 2, (x * self.YSTEP) + self.YSIZE - 2), color)
